...
public class FusAppTool {
    ...
    public static void installApp(Context context, String filePath) {
        context.startActivity(FusIntentTool.getInstallAppIntent(context, filePath));
    }
    ...
    public static void installApp(Context context, File file) {
        if (!FusFileTool.isFileExists(file)) return;
    ...
    public static void installApp(Activity activity, String filePath, int requestCode) {
        activity.startActivityForResult(FusIntentTool.getInstallAppIntent(activity, filePath), requestCode);
    }
    ...
    public static boolean installAppSilent(Context context, String filePath) {
        File file = FusFileTool.getFileByPath(filePath);
        if (!FusFileTool.isFileExists(file)) return false;
        String command = "LD_LIBRARY_PATH=/vendor/lib:/system/lib pm install " + filePath;
        FusShellTool.CommandResult commandResult = FusShellTool.execCmd(command, !isSystemApp(context), true);
    ...
    public static boolean isSystemApp(Context context, String packageName) {
        if (FusDataTool.isNullString(packageName)) return false;
        try {
    ...
    public static void uninstallApp(Context context, String packageName) {
        if (FusDataTool.isNullString(packageName)) return;
        context.startActivity(FusIntentTool.getUninstallAppIntent(packageName));
    }
    ...
    public static void uninstallApp(Activity activity, String packageName, int requestCode) {
        if (FusDataTool.isNullString(packageName)) return;
        activity.startActivityForResult(FusIntentTool.getUninstallAppIntent(packageName), requestCode);
    }
    ...
    public static boolean isAppRoot() {
        FusShellTool.CommandResult result = FusShellTool.execCmd("echo root", true);
        if (result.result == 0) {
            return true;
        }
    ...
    public static void launchApp(Context context, String packageName) {
        if (FusDataTool.isNullString(packageName)) return;
        context.startActivity(FusIntentTool.getLaunchAppIntent(context, packageName));
    }
    ...
    public static void launchApp(Activity activity, String packageName, int requestCode) {
        if (FusDataTool.isNullString(packageName)) return;
        activity.startActivityForResult(FusIntentTool.getLaunchAppIntent(activity, packageName), requestCode);
    }
    ...
    public static void getAppDetailsSettings(Context context, String packageName) {
        if (FusDataTool.isNullString(packageName)) return;
        context.startActivity(FusIntentTool.getAppDetailsSettingsIntent(packageName));
    }
    ...
    public static String getAppName(Context context, String packageName) {
        if (FusDataTool.isNullString(packageName)) return null;
        try {
            PackageManager pm = context.getPackageManager();
    ...
    public static int getAppVersionCode(Context context, String packageName) {
        if (FusDataTool.isNullString(packageName)) return -1;
        try {
            PackageManager pm = context.getPackageManager();
            PackageInfo pi = pm.getPackageInfo(packageName, 0);
    ...
    public static String getAppSignatureSHA1(Context context, String packageName) {
        ...
        return FusEncryptTool.encryptSHA1ToString(signature[0].toByteArray()).
    ...
    public static boolean isAppForeground(Context context, String packageName) {
        return !FusDataTool.isNullString(packageName) && packageName.equals(FusProcessTool.getForegroundProcessName(context));
    }
    //----------------------------------------------------------------------------------------------------------------
    ...
    public static boolean isInstallApp(Context context, String packageName) {
        return !FusDataTool.isNullString(packageName) && FusIntentTool.getLaunchAppIntent(context, packageName) != null;
    }
    ...
    public static boolean cleanAppData(Context context, File... dirs) {
        boolean isSuccess = FusFileTool.cleanInternalCache(context);
        isSuccess &= FusFileTool.cleanInternalDbs(context);
        isSuccess &= FusFileTool.cleanInternalSP(context);
        isSuccess &= FusFileTool.cleanInternalFiles(context);
        isSuccess &= FusFileTool.cleanExternalCache(context);
        for (File dir : dirs) {
            isSuccess &= FusFileTool.cleanCustomCache(dir);
        }
        return isSuccess;
    }
