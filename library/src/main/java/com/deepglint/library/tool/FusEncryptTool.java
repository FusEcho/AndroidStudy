...
import static com.deepglint.library.tool.FusDataTool.bytes2HexString;
import static com.deepglint.library.tool.FusDataTool.hexString2Bytes;

/**
 * Created by gaofengdeng 2020/4/18
 **/
public class FusEncryptTool {
    ...
    public static byte[] encryptDES2Base64(byte[] data, byte[] key) {
        return FusEncodeTool.base64Encode(encryptDES(data, key));
    }
    ...
    public static byte[] decryptBase64DES(byte[] data, byte[] key) {
        return decryptDES(FusEncodeTool.base64Decode(data), key);
    }
    ...
    public static byte[] encrypt3DES2Base64(byte[] data, byte[] key) {
        return FusEncodeTool.base64Encode(encrypt3DES(data, key));
    }
    ...
    public static byte[] decryptBase64_3DES(byte[] data, byte[] key) {
        return decrypt3DES(FusEncodeTool.base64Decode(data), key);
    }
    ...
    public static byte[] encryptAES2Base64(byte[] data, byte[] key) {
        return FusEncodeTool.base64Encode(encryptAES(data, key));
    }
    ...
    public static byte[] decryptBase64AES(byte[] data, byte[] key) {
        return decryptAES(FusEncodeTool.base64Decode(data), key);
    }
